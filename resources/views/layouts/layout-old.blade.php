...
<body onclick="hide_menu()">
	<ul class="mobile-menu close">
		...
		<li><a href="{{route('about')}}" >О ПРЕДПРИЯТИИ</a></li>
		<li><a href="{{route('manuf')}}">Производственные цеха</a></li>
		<li><a href="{{route('modern')}}">Модернизация и ЛОКализация</a></li>
		<li><a href="{{route('structures')}}">Структурные подразделения</a></li>
		<li><a href="{{route('komitets')}}">Комитеты</a></li>
