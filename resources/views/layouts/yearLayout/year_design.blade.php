...
<head>
    ...
    <title>@lang('about.history_main')</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/frontend_css/about/year/style.css') }}">
    <link rel="stylesheet" href="{{ asset('css/frontend_css/about/year/fonts.css') }}">
...
<script src="{{ asset('css/frontend_css/about/year/script.js') }}"></script>
</body>
</html>