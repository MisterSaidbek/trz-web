...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/frontend_css/structure/structures/style.css') }}">
    <link rel="stylesheet" href="{{ asset('css/frontend_css/structure/structures/fonts.css') }}">
...
<script src="{{ asset('css/frontend_css/structure/structures/script.js') }}"></script>
</body>
</html>