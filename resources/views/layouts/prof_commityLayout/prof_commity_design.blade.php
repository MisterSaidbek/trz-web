...
<head>
    ...
    <title>Профсоюзный комитет</title>
    ...
    {{--   <link rel="stylesheet" href="{{ asset('css/frontend_css/komitets/prof_commities/style.css') }}">
       <link rel="stylesheet" href="{{ asset('css/frontend_css/komitets/prof_commities/fonts.css') }}">--}}
</head>
